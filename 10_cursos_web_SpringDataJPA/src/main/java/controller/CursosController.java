...
public class CursosController {
	...
	@RequestMapping(value="formAlta") // sustituimos GetMapping por RequestMapping hacemos que se pueda entrar desde cualquier petición (get o post)
	...
	public String alta(@ModelAttribute CursoDto curso) {
		return service.nuevo(curso)?"forward:/formAlta":"error"; // se pone forward:/ +nombre de lapágina a la queremos que vaya
	}
